...
export const threadsKey = ({ chainId, boardId }: ThreadsQueryKeyParams) =>
  ['threads', chainId, boardId] as const

export const threadKey = ({ chainId, boardId, threadId }: ThreadQueryKeyParams) =>
  ['chain', chainId, 'board', boardId, 'thread', threadId] as const
