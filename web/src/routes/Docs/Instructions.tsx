  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <h4>2. Dedicated RPCs</h4>
        <p>an RPC faciliates your communication with the blockchain.  To access logs one requires an RPC with an archive node. While metamask and coinbase and other wallet providers give you default ones, they are often restricted in what they can access due to rate limiting.  To guarantee you can access hashchans content, it is recommended to get a dedicated RPC url from a provider such as <a target="_blank" href="https://www.alchemy.com/">Alchemy</a>.  By editing the network in metamask you can add a new RPC and get much better log access</p>
        <h4>3. Funding the Wallet</h4>
        <p>Funding a wallet is highly dependent on ones locality, I recommend to search "how to get etheruem in X country.  For now, I you reach out via discord I may be able to send you some testETH on the sepolia network to get you started trying the dapp out"</p>
