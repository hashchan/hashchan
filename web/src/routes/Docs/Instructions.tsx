  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p>Metamask has partnered with Coinbase to direct deposit into your wallet. Optionally one may choose to instead use the <a target="_blank" href="https://www.coinbase.com/en-gb/wallet/learn-web3/how-to-fund-your-coinbase-wallet">Coinbase Wallet</a> instead.</p>
